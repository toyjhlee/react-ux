import r$1, { useRef, useDebugValue, useContext, createElement, useState, useEffect } from 'react';
...
// option enter, click 시 focus 는 상위 Button 으로 이동
// option 은 tab 으로 이동 못 함 // 하는 버전을 하나 더 만들자
var MenuList = Ye.ul(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  border-radius: 2px;\n  border: 1px solid #dcdcdc;\n  position: absolute;\n  z-index: 1;\n\n  left: 0;\n  top: 100%;\n\n  background-color: #fff;\n\n  &[aria-hidden='true'] {\n    display: none;\n  }\n\n  max-width: 200px;\n"], ["\n  border-radius: 2px;\n  border: 1px solid #dcdcdc;\n  position: absolute;\n  z-index: 1;\n\n  left: 0;\n  top: 100%;\n\n  background-color: #fff;\n\n  &[aria-hidden='true'] {\n    display: none;\n  }\n\n  max-width: 200px;\n"])));
var Item = Ye.li(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: block;\n  padding: 0.78571429rem 1.14285714rem;\n  &:hover {\n    background-color: rgba(0, 0, 0, 0.05);\n  }\n\n  &[aria-selected='true'] {\n    color: red;\n  }\n\n  cursor: pointer;\n  white-space: nowrap;\n"], ["\n  display: block;\n  padding: 0.78571429rem 1.14285714rem;\n  &:hover {\n    background-color: rgba(0, 0, 0, 0.05);\n  }\n\n  &[aria-selected='true'] {\n    color: red;\n  }\n\n  cursor: pointer;\n  white-space: nowrap;\n"
    // interface IItem {
    //   text: string
    //   value?: number
    //   key?: string
...
function DropDown(props) {
    ...
    var _c = useState(r$1.Children.toArray(children).length), childLength = _c[0], setChildLength = _c[1];
    useEffect(function () {
        setChildLength(r$1.Children.toArray(children).length);
    }, [children]);
    useEffect(function () {
        if (isOpen === false) {
            setFocusIndex(-1);
    ...
    var onKeydown = function (e) {
        ...
        if (e.key === 'Enter') {
            ...
            var child = r$1.Children.toArray(children)[focusIndex];
            setIsOpen(false);
    ...
    var contents = [];
    r$1.Children.forEach(children, function (child, index) {
        contents.push(r$1.cloneElement(child, {
    ...
    return (r$1.createElement(Wrap, { onKeyDown: function (e) { return onKeydown(e); } },
        r$1.createElement(Button, { onClick: function () { return setIsOpen(!isOpen); }, onFocus: function () {
                //   setIsOpen(true)
            }, onBlur: function () {
                setIsOpen(false);
            } }, label),
        r$1.createElement(MenuList, { "aria-hidden": !isOpen, "data-testid": 'menulist' }, contents)));
}
DropDown.Item = Item;
var templateObject_1, templateObject_2, templateObject_3, templateObject_4;

var index = { DropDown: DropDown };
